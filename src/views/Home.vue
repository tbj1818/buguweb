<template>
  <section>
    <div class="logo_nav container">
      <div class="logo">
        <a href="javascript:;"><img src="../assets/images/logo.png" />Bugu</a>
      </div>
      <div class="nav_bg dropdown">
        ...
        <ul class="nav nav-pills dropdown-menu" id="navbar" aria-expanded="true">
          ...
          <li role="presentation" class="load"><a id="a04" href="javascript:;">创始团队</a></li>
          <li role="presentation" class="load"><a id="a05" href="javascript:;">新闻报道</a></li>
    ...
    <section class="container blockMarT" style="padding:0">
      <div class="row animatedParent">
        <div class="col-md-6">
          ...
          <p>
            <a href="https://www.bugu.one/web/buguwhitepaper.pdf" target="_blank" style="cursor: pointer;" class="atcontact ">下载白皮书</a><span
    ...
    <section class="container animatedParent blockMarT">
      <div class="row animatedParent">
        <div class="col-md-6 animated bounceInLeft a01">
          <ul class="fourlist">
            <li>
        ...
        <section class="shtjiaoshao animated bounceInLeft">
          <div class="row blockMarTop">
            <div class="col-lg-4">
              ...
              <h3>生态参与者</h3>
              <div class="lineB"></div>
              <p class="text">布谷生态系统中涉及到了诸多参与者，他们都是布谷生态得以实际成功运行的关键角 色。在这个以区块链为底层技术的去中心化技术环境下，各个角色的演进与作用发挥都有
                相应的条件和规则。每个参与者都可以通过贡献价值来参与到布谷生态的建设中，共同推
                动全球游戏产业 2.0 的进化以及区块链技术的应用落地。
              </p>
            ...
            <div class="col-lg-4">
              ...
              <div class="lineR"></div>
              <p class="text">
                布谷生态系统以区域子公司、创业孵化器、以及创投基金为基石，生态内的核心平台 包括：布谷社区、虚拟币结算中心、布谷大数据分发平台、以及布谷游戏、主播联盟、推
                广者联盟、开发者联盟、IP孵化中心等等，在此基础上布谷开展了一系列的孵化业务。
              </p>
            ...
            <div class="col-lg-4">
              ...
              <div class="lineG"></div>
              <p class="text">
                布谷生态基金会提供社区的初始启动资金，进行布谷生态的建设，对平台的开源、生 态建设审议等进行管理；同时致力于项目本身的财务、团队建设、对外关系等，使得项目 更好的运行。
              </p>
    ...
    <section class="container blockMarT animatedParent" style="padding:50px 0">
      <div class="textstart animated bounceInDown a03" style="text-align:center; margin-bottom:300px">
      ...
      <div class="linepic"><img src="../assets/images/linepic.png" alt="line" />
        ...
        <div class="timeLine2 animated bounceInLeft">
          <ul>
            <li>
              <section class="bottext">
                <h1>2018-Q3</h1>
    ...
    <section class="container blockMarT animatedParent" style="padding:0">
      <div class="animated bounceInDown a04">
        <div class="textstart">
          <div class="lineR"></div>
          <h4 class="media-heading ">创始团队</h4>
        </div>
      </div>
      <!-- 套餐 -->
      <section class="animatedParent">
        <div class="row blockMarTop peoplethree">
          <!--begin col-md-4 -->
          ...
          <div class="col-md-4 animated bounceInLeft ">
            ...
            <div class="pricing-box-green ">
              ...
              <div class="peopletext">
                ...
                <h2>市场营销官</h2>
                <p class="price textgray">
                  西北大学哲学硕士，多年互联网产品营销推广经验，有丰富的媒体资源，与多家大型媒体保持良好关系。 在品牌营销和市场推广方面，也有着多年的经验。 2015 年进入区块链行业，一
                  直致力于项目孵化、投资并购以及市场推广等相关工作。
                </p>
              </div>
            </div>
            <!--end pricing-box -->
    ...
    <section class="container blockMarT animatedParent">
      <div class="animated bounceInDown a05">
        <div class="textstart">
          <div class="lineB"></div>
          <h4 class="media-heading">新闻报道</h4>
        </div>
      </div>
      <div class="row blockMarTop">
        <!--begin col-md-4 -->
        <div class="col-md-4 animated bounceInLeft">
          <section class="newspic" data-toggle="modal" data-target=".bs-example-modal-lg">
            <!-- <router-link to="/news"> -->
              <img src="../assets/images/banner1.png" />
              <div class="bottomText">
                <h1>BUGUChain社区蓬勃发展</h1>
                <p>BUGUChain社区蓬勃发展 注册用户超20万...</p>
              </div>
              <div class="peopletext newspichover" to="/news">
                <h6>BUGUChain社区蓬勃发展</h6>
                <p class="price textgray">
                  UGUChain社区蓬勃发展，注册用户超20万 据BUGUChain（布谷链）COO Kevin Wu透露，布谷APP累计注册用户规模超20万人。Kevin Wu表示：“布谷社区用户的建设和活跃驱动了布谷链的快速迭代，社区用户、玩...
                </p>
                <p class="bottomtime">2019-05-09 17:01:07</p>
              </div>
            <!-- </router-link> -->
          </section>
        </div>
        <div class="col-md-4 animated bounceInLeft">
          <section class="newspic" data-toggle="modal" data-target=".bs-example-modal-lg2">
           
              <img src="../assets/images/newsbanner2.png" />
              <div class="bottomText">
                <h1>日本游戏启示录：美术、游戏性</h1>
                <p>日本游戏启示录：美术、游戏性、题材...当下的链游缺什么？...</p>
              </div>
              <div class="peopletext newspichover">
                <h6>日本游戏启示录：美术、游戏性、题材...</h6>
                <p class="price textgray">
                  如果你是游戏死忠粉，一定不会对“雅达利大崩溃”感到陌生。
1982年，由华纳斥巨资买下授权，当年家用机巨头雅达利亲自开发的电影改编游戏...
                </p>
                <p class="bottomtime">2019-05-09 17:01:07</p>
              </div>
        ...
        <div class="col-md-4 animated bounceInLeft">
          <section class="newspic" data-toggle="modal" data-target=".bs-example-modal-lg3">
            
              <img src="../assets/images/newsbanner3.png" />
              <div class="bottomText">
                <h1>BGT上所前空投 布谷APP最强福利</h1>
                <p>BGT上所前空投 布谷APP最强福利 一起瓜分2000万BGT...</p>
              </div>
              <div class="peopletext newspichover">
                <h6>BGT上所前空投 布谷APP最强福利</h6>
                <p class="price textgray">
                  BGT上线交易所前最后一次空投即将在今天下午启航，预计5月中旬上线知名交易所进行IEO，所有注册APP的用户均有一次开启宝箱机会，最高获得100BGT，每邀请一人可增加一次开宝箱机会，不设上限。
                </p>
                <p class="bottomtime">2019-05-09 17:01:07</p>
              </div>
        ...
        <div class="modal-content">
          <section class="animatedParent">
            <div class="newscontent">
                <!-- <img src="../assets/images/newsimg.png" /> -->
                <section class="cont">
                    <h1>BUGUChain社区蓬勃发展 注册用户超20万</h1>
                    <h6>发布于 2019-05-10 17:34</h6>
                    <div class="newstext">
                      <div class="newstitle">BUGUChain社区蓬勃发展 注册用户超20万</div>
                         UGUChain社区蓬勃发展，注册用户超20万
据BUGUChain（布谷链）COO Kevin Wu透露，布谷APP累计注册用户规模超20万人。Kevin Wu表示：“布谷社区用户的建设和活跃驱动了布谷链的快速迭代，社区用户、玩家及游戏开发者均能享受到生态发展带来的娱乐价值和经济价值，布谷生态目前正在蓬勃发展”。
                        <p style="width:100%; margin:30px auto">
        ...
        <div class="modal-content">
          <section class="animatedParent">
            <div class="newscontent">
                <!-- <img src="../assets/images/newsimg.png" /> -->
                <section class="cont">
                    <h1>日本游戏启示录：美术、游戏性、题材...当下的链游缺什么？</h1>
                    <h6>发布于 2019-05-10 17:34</h6>
                    <div class="newstext">
                      <div class="newstitle">日本游戏启示录：美术、游戏性、题材...当下的链游缺什么？</div>
                        如果你是游戏死忠粉，一定不会对“雅达利大崩溃”感到陌生。<br>
...
<br>
                      1983年，几百万盘滞销的《E.T.》游戏卡带被埋进了新墨西哥州的阿拉莫戈多垃圾镇，宣告一个时代的结束。<br>
                      ...
                      之后几年，美国很少有人再谈家用机市场，一个行业濒临崩溃。
                        ...
                        <p>
                          同年，日本的任天堂抓住了机会，迅速推出了红白机占据市场，开启了电子游戏的新时代。<br>

在之后很长一段时间内，日本游戏厂商作为领头人，为行业带来众多标杆性质的作品。就算如今的日厂技术力渐渐落了下风，但游戏内容设计方面依然有着独到的魅力，这与日本国内整体游戏开发环境密不可分。
<br>
2017年，任天堂推出了两个重量级作品。《塞尔达传说 旷野之息》用淡雅的美术效果回避了Switch机能短板，并展示了他们对于“沙盒游戏”的极致理解，直接斩获当年TGA大奖。《超级马力欧 奥德赛》则打破了人们对于马力欧游戏的传统观念，将“箱庭类”马力欧推上了一个更高的地位。
<br>
...
在区块链游戏领域也是如此。My Crypto Heroes（后文简称MCH）横空出世后，迅速打进DApp榜单前三，交易量一度超过《谜恋猫》排名第一，大火的同时不仅让链游圈的玩家们再一次感慨：
...
My Crypto Heroes游戏采用了像素风的整体设计，这对于老玩家是个产生亲近感的加分项。但就算玩家不喜欢像素美术，也无法否定开发组Double Jump在角色设计上的用心。
<br>

Double Jump没有用粗像素敷衍了事，而是细致地设计了每一名角色的形象，使角色图在保证可爱或帅气的同时也包含了一些专属细节。比如格林兄弟的图中，两人之间鸡、猫、狗、驴子四只小动物的梗出自格林童话里的《不莱梅乐队》。
        ...
        <div class="modal-content">
          <section class="animatedParent">
            <div class="newscontent">
                <!-- <img src="../assets/images/newsimg.png" /> -->
                <section class="cont">
                    <h1>BGT上所前空投 布谷APP最强福利 一起瓜分2000万BGT</h1>
                    <h6>发布于 2019-05-11 14:34</h6>
                    <div class="newstext">
                      <div class="newstitle">BUGUChain社区蓬勃发展 注册用户超20万</div>
                        ...
                        <p>
                            关于BGT<br>
                        布谷BGT是新一代游戏分发公链通证，由云图资本（牛顿协议、IOEX、亦来云早期投资机构）和NOC Ventures（硅谷区块链项目主要投资机构）领投<br>
                        对接千亿美元游戏市场<br>
                        让玩家重新掌握话语权<br>
                        重新定义游戏分发行业<br>
                        共同打造改变世界的顶级游戏生态
